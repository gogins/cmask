        ...
        switch (xsymbol(tok))
            ...
            case xseg	:	// pfield mit Segment-Makro
                ...
                if(myisnumber(tok))
                    ...
                    if(ifl) iy = ix-2;
                    double *fx = new double[iy/2];
                    double *fy = new double[iy/2];
            ...
            case xmask	:	// mask
                ...
                if(myisnumber(tok))
                    ...
                    ix = iy = lenlist(&token,n, &ifl);
                    if(ifl) iy = ix-2;
                    double *fx_ = new double[iy/2];
                    double *fy_ = new double[iy/2];
                    funlist(&token,n, ix,fx_,fy_,&iplval,&iplmode);
                    p.p[pnum].pmask.setval(1,fx_,fy_,iy/2);
                    p.p[pnum].pmask.setipl(1,iplval,iplmode);
                    delete fx_;
                    delete fy_;
                    n += ix;
                ...
                */		
                ...
                if(n<nt)
                    ...
                    if(myisnumber(tok))
                        ...
                        ix = iy = lenlist(&token,n, &ifl);
                        if(ifl) iy = ix-2;
                        double *fx_ = new double[ix/2];
                        double *fy_ = new double[iy/2];
                        funlist(&token,n, ix,fx_,fy_,&iplval,&iplmode);
                        p.p[pnum].pquant.setval(2,fx_,fy_,iy/2);
                        p.p[pnum].pquant.setipl(2,iplval,iplmode);
                        delete fx_;
                        delete fy_;
                        n += ix;
